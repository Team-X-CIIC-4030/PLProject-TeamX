...
tokens = tuple(tokens) + (
		...
		'GREATER','EQUAL','DOT','PERCENT','BACKQUOTE','CIRCUMFLEX','TILDE',	'AT', 'LPAREN', 'RPAREN',
	    'LBRACE', 'RBRACE', 'LSQB', 'RSQB', 'NEWLINE','INUMBER','FNUMBER', 'NUMBER','INDENT', 'DEDENT',
		 'STRING', 'NAME','WS', 'ENDMARKER'
	)
